		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#nmspSouthsouthern-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nmspSouthsouthern-display": {
								"semanticObject": "nmspSouthsouthern",
								"action": "display",
								"description": "Midnight Conditions",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nmspSouth.southern",
									"url": sap.ui.require.toUrl("nmspSouth/southern")
								}
							}
						}
					}
